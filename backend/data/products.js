const products = [
  ...
  },
  {
    ...
    description:
      'How Today\'s Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses. A must-read for any aspiring entrepreneur.',
    brand: 'Eric Ries',
    category: 'Books',
    price: 29.99,
    countInStock: 15,
  ...
  },
  {
    ...
    description:
      'An Easy & Proven Way to Build Good Habits & Break Bad Ones. Tiny Changes, Remarkable Results. A masterclass on habit formation.',
    brand: 'James Clear',
    category: 'Books',
    price: 24.99,
    countInStock: 20,
  ...
  },
  {
    ...
    description:
      'A comfortable and stylish casual t-shirt for men. Made from 100% premium cotton, perfect for everyday wear.',
    brand: 'Modern Apparel',
    category: 'Clothing',
    price: 19.99,
    countInStock: 50,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      'A classic denim jacket for women. Versatile and timeless, this jacket can be paired with any outfit for a chic look.',
